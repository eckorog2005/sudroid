/**
 * InvalidPositionLocationException.java
 */
 ...
 *
 */
public class InvalidPositionLocationException extends Exception {
	...
	public InvalidPositionLocationException(String temp){
		super(temp);
	}
}
