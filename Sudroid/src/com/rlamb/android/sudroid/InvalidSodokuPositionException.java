/**
 * InvalidSodokuPositionException.java
 */
...
/**
 * invalid soduko position exception
 * 
 * @author rlamb
 *
 */
public class InvalidSodokuPositionException extends Exception {

	//id
	private static final long serialVersionUID = 1L;
	
	public InvalidSodokuPositionException(String temp){
		super(temp);
	}
